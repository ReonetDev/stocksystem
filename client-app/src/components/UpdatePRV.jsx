...
const UpdatePRV = () => {
    ...
    useEffect(() => {
        const fetchPRVDevice = async () => {
            setLoading(true);
            try {
                const token = localStorage.getItem('token');
                const response = await axios.get(`http://localhost:5260/api/PRVDevices/${id}`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                setFormData(response.data);
                setSiteName(response.data.siteName);
            } catch (error) {
                console.error('Failed to fetch PRV device:', error);
                toast.error('Failed to load PRV device data.');
                navigate('/prv-list'); // Redirect if not found or error
            } finally {
                setLoading(false);
            }
        };
                    ...
                    <Row className="mb-3">
                        <Col lg={4} md={6} sm={12}>
                            <Form.Group controlId="siteId">
                                ...
                                <Form.Control type="text" readOnly value={siteName} />
                            </Form.Group>
                        </Col>
                        <Col lg={4} md={6} sm={12}>
                    ...
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="time_Modulated_Controller">
                                ...
                                <Form.Select name="time_Modulated_Controller" value={formData.time_Modulated_Controller || false} onChange={handleChange}>
                        ...
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="pilot_make_peak">
                                ...
                                <Form.Control name="pilot_make_peak" placeholder="Pilot Make (Peak)" value={formData.pilot_make_peak || ''} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="pilot_make_offpeak">
                                ...
                                <Form.Control name="pilot_make_offpeak" placeholder="Pilot Make (Off-peak)" value={formData.pilot_make_offpeak || ''} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                </div>
                    ...
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="needle_valve_scoured">
                                <Form.Check type="checkbox" name="needle_valve_scoured" label="Needle Valve Scoured" checked={formData.needle_valve_scoured || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="main_valve_respond_to_pilot_adjustment">
                                <Form.Check type="checkbox" name="main_valve_respond_to_pilot_adjustment" label="Main Valve Respond to Pilot Adjust" checked={formData.main_valve_respond_to_pilot_adjustment || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="pilot_system_flush_bleed">
                                <Form.Check type="checkbox" name="pilot_system_flush_bleed" label="Pilot System Flush Bleed" checked={formData.pilot_system_flush_bleed || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="leaking_fittings">
                                <Form.Check type="checkbox" name="leaking_fittings" label="Leaking Fittings" checked={formData.leaking_fittings || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="strainer_clean">
                                <Form.Check type="checkbox" name="strainer_clean" label="Strainer Clean" checked={formData.strainer_clean || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="sufficient_working_Room">
                                <Form.Check type="checkbox" name="sufficient_working_Room" label="Sufficient Working Room" checked={formData.sufficient_working_Room || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                    ...
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="solenoid_Open">
                                <Form.Check type="checkbox" name="solenoid_Open" label="Solenoid Open" checked={formData.solenoid_Open || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="needle_valve_present">
                                <Form.Check type="checkbox" name="needle_valve_present" label="Needle Valve Present" checked={formData.needle_valve_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="air_Valve_present">
                                <Form.Check type="checkbox" name="air_Valve_present" label="Air Valve Present" checked={formData.air_Valve_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="lock_working">
                                <Form.Check type="checkbox" name="lock_working" label="Lock Working" checked={formData.lock_working || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="ball_valves_present">
                                <Form.Check type="checkbox" name="ball_valves_present" label="Ball Valves Present" checked={formData.ball_valves_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="restrictor_Present">
                                <Form.Check type="checkbox" name="restrictor_Present" label="Restrictor Present" checked={formData.restrictor_Present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="chamber_Cover_present">
                                <Form.Check type="checkbox" name="chamber_Cover_present" label="Chamber Cover Present" checked={formData.chamber_Cover_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="strainer_present">
                                <Form.Check type="checkbox" name="strainer_present" label="Strainer Present" checked={formData.strainer_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="ball_valve_on_bonnet_present">
                                <Form.Check type="checkbox" name="ball_valve_on_bonnet_present" label="Ball Valve on Bonnet Present" checked={formData.ball_valve_on_bonnet_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="lock_present">
                                <Form.Check type="checkbox" name="lock_present" label="Lock Present" checked={formData.lock_present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="pilot_Present">
                                <Form.Check type="checkbox" name="pilot_Present" label="Pilot Present" checked={formData.pilot_Present || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                </div>
                    ...
                    <Row className="mb-3">
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="strainer_Dirt_Box">
                                <Form.Check type="checkbox" name="strainer_Dirt_Box" label="Strainer Dirt Box" checked={formData.strainer_Dirt_Box || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col lg={3} md={6} sm={12}>
                            <Form.Group controlId="meter_Functional">
                                <Form.Check type="checkbox" name="meter_Functional" label="Meter Functional" checked={formData.meter_Functional || false} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                </div>
